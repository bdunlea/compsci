...
to illusion-1
  clear-all
  set caption "What color are the circles? (Changes made: circles are now yellow & lines are blue)"
...
to illusion-2
  clear-all
  set caption "Are the thick lines parallel? (Changes made: reversed black and white)"
  ask patches
    [ set pcolor black ]
...
to illusion-3
  clear-all
  set caption "Are the lines parallel? (Changes made: colors used are now red and pink)"
...
to illusion-4
  clear-all
  set caption "Which has the most outer circles? (Changes made: colors, size and numbers of circles)"
  set-default-shape turtles "circle"
    ...
    [ ;; middle circle
      sprout 1
        [ set color yellow
          ...
          hatch 10
            [ set size 2
              set heading 36 * counter ;; 36 represents degrees
              fd 4
...
to illusion-5
  clear-all
  set caption "Stare at the dot, then lean forward and back. (Changes made: diamonds are smaller)"
  ask patches
    [ set pcolor gray ]
...
to illusion-7
  clear-all
  set caption "Spirals or circles? (Changes made: background color to blue)"
